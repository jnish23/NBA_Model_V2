...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test, train_df, test_df = get_data_from_db(target='HOME_WL', con=connection, test_season=2021)
    connection.close()
    ...
    print("train_mae before removing correlated features", accuracy_score(y_train, train_preds))
    print("test_mae before removing correlated features", accuracy_score(y_test, test_preds))
    ...
    print("train_acc after SFS", accuracy_score(y_train, train_preds))
    print("test_acc after SFS", accuracy_score(y_test, test_preds))